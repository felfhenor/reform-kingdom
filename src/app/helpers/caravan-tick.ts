import { caravanEligibleTraders } from '@helpers/caravan';
import { isCollectibleDiscovered } from '@helpers/collectibles';
import { gamestate, updateGamestate } from '@helpers/state-game';
import { timerTicksElapsed } from '@helpers/timer';
import { worldNodeCaravan, worldNodesOfType } from '@helpers/world-nodes';
import type {
  CaravanContent,
  CaravanNodeState,
...
function pickTrader(
  ...
  const candidates = eligible.filter((trader) => trader.id !== previousTraderId);
