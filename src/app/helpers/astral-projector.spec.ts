...
import type * as MaterialsModule from '@helpers/materials';
...
vi.mock('@helpers/materials', async () => {
...
import { applyGlobalEffectAdd, applyGlobalEffectRemove } from '@helpers/global-effects';
import { getMaterialQuantity, isMaterialDiscovered } from '@helpers/materials';
  ...
  describe('pruneInvalidActiveAstralProjectorSpells', () => {
    it('drops entries whose id no longer resolves to content', () => {
      ...
      const result = pruneInvalidActiveAstralProjectorSpells([
        { astralProjectorId: spellId, startedAtTick: 0, expiresAtTick: 60 },
        { astralProjectorId: otherSpellId, startedAtTick: 0, expiresAtTick: 60 },
      ]);
