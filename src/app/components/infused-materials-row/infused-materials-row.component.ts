...
@Component({
  selector: 'app-infused-materials-row',
  ...
  templateUrl: './infused-materials-row.component.html',
  styleUrl: './infused-materials-row.component.scss',
})
export class InfusedMaterialsRowComponent {
