...
import { CaravanTradeSlotComponent } from '@components/caravan-trade-slot/caravan-trade-slot.component';
...
@Component({
  selector: 'app-caravan-trade-modal',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [CaravanTradeSlotComponent, ModalComponent, SweetAlert2Module],
  templateUrl: './caravan-trade-modal.component.html',
})
export class CaravanTradeModalComponent {
