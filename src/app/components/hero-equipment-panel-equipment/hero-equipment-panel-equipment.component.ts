...
@Component({
  selector: 'app-hero-equipment-panel-equipment',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [EquipmentSlotComponent, EquipmentItemCardComponent, ScrollingModule],
  host: {
    class: 'contents',
  },
  templateUrl: './hero-equipment-panel-equipment.component.html',
  styleUrl: './hero-equipment-panel-equipment.component.scss',
})
export class HeroEquipmentPanelEquipmentComponent {
