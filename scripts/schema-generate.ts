...
const program = TJS.getProgramFromFiles(
  [
    ...
    path.resolve(__dirname, '../src/app/interfaces/content-research.ts'),
    path.resolve(__dirname, '../src/app/interfaces/content-research-tree.ts'),
...
const contentTypeMap = {
  ...
  researchtree: 'ResearchTreeContent',
